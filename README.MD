# NELL-MDCOINS -- ( Javascript )

### Motivation
Cryptocurrencies and smart-contracts on top of a blockchain aren't the most trivial concepts to understand,things like wallets, addresses, block proof-of-work, transactions and their signatures, make more sense when they are in a broad context. Inspired by [naivechain](https://github.com/lhartikk/naivechain), this project is an attempt to provide as concise and simple cryptocurrency for the blockchain and AI research. More than that, anyone could also use these coins to buy the NELL services or products.
...
```sh
# Run a node
$ node bin/nell-mdcoin.js

# Run two nodes
$ node bin/nell-mdcoin.js -p 3001 --name 1
$ node bin/nell-mdcoin.js -p 3002 --name 2 --peers http://localhost:3001
...
```sh
# Clonning repository
$ git clone git@github.com:justdvnsh/Nell-MDCoins.git
$ cd Nell-MDCoins
$ npm install
